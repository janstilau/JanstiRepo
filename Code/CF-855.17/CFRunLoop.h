...
typedef struct __CFRunLoopSource * CFRunLoopSourceRef; // 数据源

typedef struct __CFRunLoopObserver * CFRunLoopObserverRef; // 观察者

typedef struct __CFRunLoopTimer * CFRunLoopTimerRef; // 时间源
