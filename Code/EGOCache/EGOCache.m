...
@interface EGOCache () {
    ...
    dispatch_queue_t _diskQueue; // 文件操作的队列.
...
- (instancetype)initWithCacheDirectory:(NSString*)cacheDirectory {
    if((self = [super init])) {
        ...
        _directory = cacheDirectory; // 存储了目录.
...
// 最核心的方法, 其实就是把数据, 写到对应的文件上. 然后, 进行时间管理.
