...
/**
 *
 There is no a appropriate to put setupCache() code. So a lot of times, GNU put the setup in the method.
 */
NSRange
NSRangeFromString(NSString *aString)
{
  ...
  setupCache();
    // NSString to NSRange and NSRange to NSString is all controled is this class. So the rule is fixed.
