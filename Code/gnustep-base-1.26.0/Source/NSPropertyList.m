...
+ (void) initialize
{
    ...
    {
        NSMutableCharacterSet	*charSetM;
         ...
         */
        charSetM = [NSMutableCharacterSet new];
        [charSetM addCharactersInString:
         @"0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ"
         @"abcdefghijklmnopqrstuvwxyz"];
        [charSetM invert];
        oldQuotables = charSetM;
        
        charSetM = [NSMutableCharacterSet new];
        [charSetM addCharactersInString: @"&<>'\\\""];
        [charSetM addCharactersInRange: NSMakeRange(0x0001, 0x001f)];
        [charSetM removeCharactersInRange: NSMakeRange(0x0009, 0x0002)];
        [charSetM removeCharactersInRange: NSMakeRange(0x000D, 0x0001)];
        [charSetM addCharactersInRange: NSMakeRange(0xD800, 0x07FF)];
        [charSetM addCharactersInRange: NSMakeRange(0xFFFE, 0x0002)];
        xmlQuotables = charSetM;
                ...
                errorDescription: (NSString**)anErrorString
{
    NSError *error = nil;
    /**
    * pass a error as a check in sub logic is very common.
    */
