// Note by ZhouKang At 2016年12月23日: 新版本摩擦采用 WKWebView，并对桥接文件库文件进行更新，为了兼顾iOS旧版本和碍安卓用户，故桥接方法需要写两个方法
        ...
        function checkStates() {
            bridge.callHandler('CallInterface', { 'url': baseUrl + 'check', 'params': {} }, function (d) {
                ...
                if (d.succes) {
                    ...
                    d.result.buy.indexOf(66) > -1 ? $('#btn-recharge-66').prop('disabled', true) : $('#btn-recharge-66').prop('disabled', false);
