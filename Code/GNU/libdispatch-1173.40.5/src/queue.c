...
DISPATCH_ALWAYS_INLINE
static inline void
_dispatch_barrier_sync_f_inline(dispatch_queue_t dq, // 队列.
								void *ctxt,
								dispatch_function_t func, // 任务.
								uintptr_t dc_flags)
{
	dispatch_tid tid = _dispatch_tid_self();
...
// _dispatch_root_queue_drain 的实现.
static void
