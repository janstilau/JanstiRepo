...
(NSURLCredential*)credential inProtectionSpace: (NSURLProtectionSpace*)space
{
...
{
    if ([auth isKindOfClass: [NSString class]] != YES) { return nil; }
    ...
    // 前面的都是解析过程, 在这里用解析完的值, 生成最终的 space 对象.
