...
/*
 Flatten 只会进行第一层的抽取.
 它存储的, base, 要是一个 Sequence, 这个 Sequence 里面的元素, 又要是一个 Sequence.
 Flatten 会把里面的元素进行展开, 放到一起.
 */
...
extension FlattenSequence.Iterator: IteratorProtocol {
    ...
    /*
     关键就是这里, 在返回值的时候, 如何进行操作.
     */
    @inlinable // lazy-performance
    public mutating func next() -> Element? {
        repeat {
            /*
             inner, 是每个小 Sequence 的迭代器. 如果 Inner 有值, 代表着, 正在进行迭代小的 Sequence.
             */
...
/*
 如果, Sequence 的元素也是 Sequence, 才能使用这个函数.
 */
