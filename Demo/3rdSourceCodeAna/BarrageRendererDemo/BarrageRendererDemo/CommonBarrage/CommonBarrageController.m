...
- (void)initBarrageRenderer
{
    ...
    _renderer.view.layer.borderColor = [[UIColor redColor] CGColor];
    _renderer.view.layer.borderWidth = 2;
    ...
    // 弹幕的渲染还是需要一个 view, 只不过这个 view 是自己进行的管理.
