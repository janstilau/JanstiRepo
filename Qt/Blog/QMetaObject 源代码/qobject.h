...
public:
    ...
    QObject *q_ptr; // 这个指针, 是指向 QObject 对象的.
    QObject *parent; 
    QObjectList children; // Object tree 的实现
    ...
    uint unused : 25;
    int postedEvents; // 在自己身上的已经 post 的事件的个数.
...
class Q_CORE_EXPORT QObject
{
    ...
    Q_DECLARE_PRIVATE(QObject) // 真正的存储, 在 QObjectPrivateData 的内部.
