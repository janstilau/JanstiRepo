...
/*!
    这一段说明了, 一个 Applicaiton, 其实应该只有一个 QNetworkAccessManager 进行网络请求, 因为一个 App 其实会共享那些网络请求的设置.
    ...
    这一段说明, QNetworkAccessManager 是异步请求.
    ...
    这一段明确的说明了, Reply 对象应该使用 deleteLater.
